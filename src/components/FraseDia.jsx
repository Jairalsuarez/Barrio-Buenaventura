    ...
    <section className="py-12 bg-[#faf7f2]">
      <div className="max-w-lg mx-auto px-6">
        <div className="flex gap-3">
          <div className="text-sage-400 flex-shrink-0 leading-none" aria-hidden="true">
          ...
          <div>
            ...
            <p className="text-xs text-warm-600 dark:text-warm-300 mt-1.5 font-medium">{frase.referencia}</p>
          </div>
        </div>
      </div>
    </section>
