import AgendaAcontecimientos from './AgendaAcontecimientos'

export default function PageActividades({ onBack, userId, isPredefinido, userLlamamiento, acontecimientos }) {
  return (
